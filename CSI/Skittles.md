...
Nota: também é possível encontrar um comentário no [código-fonte](https://pt.wikipedia.org/wiki/C%C3%B3digo-fonte) da página spbre este mesmo diretório. (*/admin.php*).
